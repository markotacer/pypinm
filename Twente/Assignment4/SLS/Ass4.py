...
def segdynshell(t,state,parms):
   ...
   """
    ...
    V=np.array(
        [?? # Fx nseg+1 horizontal joint reaction forces
         ?? # Fy nseg+1 vertical joint reaction forces
         ?? # M nseg+1 net joint moments
         ??  # Fextx nseg horizontal external forces
         ??  # Fexty nseg vertical externalforces
         ?? # Mext nseg external moments
         ?? # phidd nseg segment angular accelerations
         ??], # [xbdd ybdd] horizontal and vertical base acceleration
